...
import { assignSectionSlugs } from "./edu-section-slugs";
...
export function getSectionsFromPost(post) {
  ...
  const parsed = parseHtmlIntoSections(raw, fallbackTitle);
  return { sections: assignSectionSlugs(parsed.sections) };
}
